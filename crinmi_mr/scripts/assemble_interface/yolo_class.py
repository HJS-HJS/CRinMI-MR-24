pi = 3.14159265358979
CLASS = {
    0:  {'name': 'a_L_shape_angle'      , 'type': '.obj', "voxel_size" : 0.002 ,  'number_of_points': 8000  , 'rotate':[
                                                                                                                        [[0, 0, 0],      4, 6], 
                                                                                                                        [[pi/2, 0, 0],   4, 6],
                                                                                                                        [[0, pi*3/4, 0], 12, -1]
                                                                                                                        ]},
    1:  {'name': 'a_bearing_holder'     , 'type': '.stl', "voxel_size" : 0.001 ,  'number_of_points': 8000  , 'rotate':[
                                                                                                                        [[0, 0, 0],     1, 7], 
                                                                                                                        [[pi/2, 0, 0],  2, 8]           
                                                                                                                        ]},
    2:  {'name': 'a_cam_zig'            , 'type': '.stl', "voxel_size" : 0.0012,  'number_of_points': 8000  , 'rotate':[
                                                                                                                        [[0, 0, 0],      2, 9], 
                                                                                                                        [[-pi/2, 0, 0],  2, 10], 
                                                                                                                        [[pi*4/6, 0, 0], 2, -1] 
                                                                                                                        ]},
    3:  {'name': 'a_hex_wrench'         , 'type': '.obj', "voxel_size" : 0.0013 , 'number_of_points': 6000  , 'rotate':[
                                                                                                                        [[0, 0, 0],  4, 12], 
                                                                                                                        [[pi, 0, 0], 4, 11]     
                                                                                                                        ]},
    4:  {'name': 'a_rod_end_bearing'    , 'type': '.stl', "voxel_size" : 0.0015 , 'number_of_points': 8000  , 'rotate':[
                                                                                                                        [[0, 0, 0],    1, 14], 
                                                                                                                        [[0, pi/2, 0], 2, 14], 
                                                                                                                        [[pi/2, 0, 0], 2, 13]    
                                                                                                                        ]},
    5:  {'name': 'a_roller'             , 'type': '.stl', "voxel_size" : 0.001 ,  'number_of_points': 6000  , 'rotate':[
                                                                                                                        [[0, 0, 0],     1, 15], 
                                                                                                                        [[pi/2, 0, 0],  1, 16]  
                                                                                                                        ]},
    ...
    6:  {'name': 'g_L_shape_angle'      , 'type': '.obj', 'voxel_size': 0.001   , 'number_of_points': 5000  , 'rotate': 15 },
