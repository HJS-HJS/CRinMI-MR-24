...
if __name__=='__main__':
    ...
    # load image
    rgb = cv2.imread("APP/data/2024_06_19_14_50_37__rgb.png")
    depth = cv2.imread("APP/data/2024_06_19_14_50_37__depth.png", cv2.IMREAD_UNCHANGED)
    ...
    ret = detector.object_detection(rgbd=rgbd)
