...
CLASS = {
    ...
    6:  {'name': 'g_L_shape_angle'      , 'type': '.obj', 'voxel_size': 0.004   , 'number_of_points': 5000  , 'rotate': 13 },
    7:  {'name': 'g_bearing_holder_x'   , 'type': '.obj', 'voxel_size': 0.002  , 'number_of_points': 5000  , 'rotate': 1  },
    8:  {'name': 'g_bearing_holder_y'   , 'type': '.obj', 'voxel_size': 0.004   , 'number_of_points': 5000  , 'rotate': 1  },
    9:  {'name': 'g_cam_zig_x'          , 'type': '.obj', 'voxel_size': 0.002  , 'number_of_points': 5000  , 'rotate': 1  },
    10: {'name': 'g_cam_zig_y'          , 'type': '.obj', 'voxel_size': 0.005   , 'number_of_points': 5000  , 'rotate': 2  },
    11: {'name': 'g_hex_wrench_x'       , 'type': '.obj', 'voxel_size': 0.006  , 'number_of_points': 5000  , 'rotate': 2  },
    12: {'name': 'g_hex_wrench_y'       , 'type': '.stl', 'voxel_size': 0.006   , 'number_of_points': 10000 , 'rotate': 13 },
    13: {'name': 'g_rod_end_bearing_x'  , 'type': '.obj', 'voxel_size': 0.002 , 'number_of_points': 5000  , 'rotate': 2  },
    14: {'name': 'g_rod_end_bearing_y'  , 'type': '.obj', 'voxel_size': 0.002  , 'number_of_points': 5000  , 'rotate': 2  },
    15: {'name': 'g_roller_x'           , 'type': '.obj', 'voxel_size': 0.002  , 'number_of_points': 5000  , 'rotate': 12 },
    16: {'name': 'g_roller_y'           , 'type': '.obj', 'voxel_size': 0.002  , 'number_of_points': 5000  , 'rotate': 1  },
}
