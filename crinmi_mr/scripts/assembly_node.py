...
class Test(object):
    ...
    def grip_point2matrix(self, point, pose):
        ...
        # return pose2matrix([point[0], point[1], point[2], 90, 0, 42.8 - pose])
    ...
    def test(self):
        ...
        while True:
            ...
            if user_input == 'q':
                ...
                # Get grasp pose
                grasp_matrix = self.get_grasp_pose(obj)
                ...
                self.place(obj[-1], guide_idx, grasp_matrix)
            else:
                continue
